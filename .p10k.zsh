# Generated by Powerlevel10k configuration wizard on 2020-02-08 at 12:03 -03.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 36529.
# Wizard options: nerdfont-complete + powerline, small icons, classic, dark,
# angled separators, sharp heads, blurred tails, 1 line, sparse, many icons, concise,
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  # Default current directory background color.
  #typeset -g POWERLEVEL9K_DIR_BACKGROUND=242
  ...
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH='12%'
  # When `dir` segment is on the last prompt line, try to shorten it enough to leave at least this
  # many columns for typing commands.
  typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS=90
  # When `dir` segment is on the last prompt line, try to shorten it enough to leave at least
  # COLUMNS * POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS_PCT * 0.01 columns for typing commands.
  typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS_PCT=90
