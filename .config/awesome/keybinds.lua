...
keybinds.global = gears.table.join(
    ...
    awful.key({}, "XF86AudioPlay",
        function()
            ...
            awful.spawn("mpc -q toggle", false)
        end,
        {description = "Toogle audio", group = "media"}
    ),
    awful.key({}, "XF86AudioStop",
        function()
            awful.spawn("playerctl stop", false)
            awful.spawn("mpc -q stop", false)
        end,
    ...
    awful.key({}, "XF86MonBrightnessDown",
        ...
        {description = "Down Brightness", group = "media"}
    ),

    -- Standard program
    awful.key({ modkey, }, "Return",
        function ()
            awful.spawn(default.terminal, false)
        end,
        {description = "open a terminal", group = "launcher"}
    ),
    awful.key({ modkey, }, "d",
        function ()
            awful.spawn(default.rofi, false)
        end,
        {description = "open rofi menu", group = "launcher"}
    ),
    awful.key({ modkey, }, "q",
        function ()
            awful.spawn(default.browser, false)
        end,
        {description = "open browser", group = "launcher"}
    ),
    awful.key({ modkey, }, "e",
        function ()
            awful.spawn(default.editor_cmd, false)
        end,
        {description = "open editor", group = "launcher"}
    ),
    awful.key({ modkey, }, "f",
        function ()
            awful.spawn(default.filemanager_cmd, false)
        end,
...
for i = 1, 9 do
    keybinds.global = gears.table.join(keybinds.global,
        -- View tag only.
...
globalkeys = keybinds.global
clientkeys = keybinds.client
